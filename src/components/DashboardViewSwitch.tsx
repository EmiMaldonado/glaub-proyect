...
const DashboardViewSwitch: React.FC = () => {
  ...
  return (
    <div className="flex items-center gap-1 p-1 bg-background-contrast rounded-lg w-full md:w-auto order-2 md:order-none mt-3 md:mt-0 shadow-md md:inline-flex" data-testid="dashboard-view-switch">
      <Button
