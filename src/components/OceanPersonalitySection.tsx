...
const OceanPersonalitySection: React.FC<OceanPersonalitySectionProps> = ({
  ...
  return <Card className="w-full h-full min-h-[400px]">
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription className="mt-1 flex items-center gap-2">
              <span>
                {hasRealData ? "Based on real team conversation data" : "Analysis based on available data - encourage team members to complete conversations for more accurate insights"}
              </span>
              {cacheStatus === 'cached'}
            </CardDescription>
          </div>
      ...
      <CardContent className="space-y-6">
        ...
        {oceanTraits.every(trait => trait.value === 0) ? <div className="text-center py-8">
            <div className="text-sm text-muted-foreground">
              No information available yet on your team
            </div>
          </div> : <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
        ...
        <div>
                ...
                {teamDescription.includes('processing') || teamDescription.includes('generating') ? <div className="text-center py-4">
                  ...
                  </div> : teamDescription.includes('unavailable') || teamDescription.includes('service') ? <div className="text-center py-4">
                    ...
                    {onRefresh && <Button variant="outline" size="sm" onClick={onRefresh} className="mt-3">
                        Try Again
                      </Button>}
