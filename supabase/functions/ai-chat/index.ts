...
PREVIOUS INSIGHTS: ${previousInsights.key_insights?.slice(0,2)?.join(', ') || 'Building career understanding'}
PERSONALITY: ${previousInsights.personality_notes?.summary?.substring(0,100) || 'Getting to know their work style'}
` : '';
