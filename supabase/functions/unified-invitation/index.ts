...
serve(async (req: Request) => {
  ...
  try {
    ...
    console.log("5. Getting profile for user:", userId);
    ...
    console.log("6. Profile result:", !!profile, "Error:", !!profileError);

    console.log("7. Getting request body");
    const { email, invitationType, teamId, message } = await req.json();
    console.log("8. Request data:", { email, invitationType, teamId });
